...
/**
 * Hardware IO implementation for the arm subsystem using a NEO Vortex motor driven by a SPARK MAX controller.
 */
public class ArmIOSparkMax implements ArmIO {
  ...
  /**
   * Constructs an ArmIOSparkMax instance.
   *
   * @param motorCanId CAN ID of the arm SPARK MAX motor controller.
   */
  public ArmIOSparkMax(int motorCanId) {
  ...
  public void updateInputs(ArmIOInputs inputs) {
    ...
    // No physical limit switches wired to SPARK MAX digital inputs by default
