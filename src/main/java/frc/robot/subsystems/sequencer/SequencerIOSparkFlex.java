 ...
 * driven by SPARK Flex controllers in leader-follower configuration.
 */
public class SequencerIOSparkFlex implements SequencerIO {
  ...
  /**
   * Constructs a SequencerIOSparkFlex instance with leader and follower CAN IDs.
   *
   * @param leaderCanId CAN ID of the primary/leader SPARK Flex controller.
   * @param followerCanId CAN ID of the secondary/follower SPARK Flex controller.
   */
  public SequencerIOSparkFlex(int leaderCanId, int followerCanId) {
    m_leaderMotor = new SparkFlex(leaderCanId, MotorType.kBrushless);
    m_followerMotor = new SparkFlex(followerCanId, MotorType.kBrushless);
  ...
  public void setBrakeMode(boolean enableBrakeMode) {
    ...
    SparkFlexConfig leaderUpdate = new SparkFlexConfig();
    ...
    SparkFlexConfig followerUpdate = new SparkFlexConfig();
